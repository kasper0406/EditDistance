...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[font=\tiny\sffamily,node distance=4.2cm]
    ...
    \node[block,fill=white!90!yellow, below=1cm of simple-unit-monge-closed](min-mult){
    ...
    \node[block,fill=white!90!cyan, right of=vertical-merge](query-sigma){
    ...
    \draw [->] (query-sigma) -- (vertical-merge);
  ...
  \begin{itemize}
    ...
    \coloredbox{white!90!yellow} The proofs of the statements included in this thesis follow the structure of the proofs supplied in the literature, but additional details are included.
    \coloredbox{white!90!green} Statements that are not mentioned or proved in the literature.
  \end{itemize}
