...
plt.figure()
plt.title("Running time for the DIST Repository computation")
...
plt.plot(fibonacci_dist['A_len'] + fibonacci_dist['B_len'], normalize_dist(fibonacci_dist), label="Fibonacci", color='b')
plt.plot(hg_repetitive_dist['A_len'] + hg_repetitive_dist['B_len'], normalize_dist(hg_repetitive_dist), label="HG Repetitive", color='g')
plt.plot(hg_nonrepetitive_dist['A_len'] + hg_nonrepetitive_dist['B_len'], normalize_dist(hg_nonrepetitive_dist), label="HG Non-repetitive", color='r')
plt.plot(hg_combined_dist['A_len'] + hg_combined_dist['B_len'], normalize_dist(hg_combined_dist), label="HG Combined", color='c')
...
plt.figure()
plt.title("Normalized running time for the DIST Repository computation")
ax1 = plt.subplot(111)
plt.xscale('log', basex=2)
plt.yscale('log', basey=2)
...
ax1.plot(hg_repetitive_dist['A_len'] + hg_repetitive_dist['B_len'], normalize_dist(hg_repetitive_dist, 'instructions'), color='g', label="HG Repetitive")
ax1.plot(hg_nonrepetitive_dist['A_len'] + hg_nonrepetitive_dist['B_len'], normalize_dist(hg_nonrepetitive_dist, 'instructions'), color='r', label="HG Non-repetitive")
ax1.plot(hg_combined_dist['A_len'] + hg_combined_dist['B_len'], normalize_dist(hg_combined_dist, 'instructions'), color='c', label="HG Combined")
...
ax2.plot(hg_repetitive_dist['A_len'] + hg_repetitive_dist['B_len'], (hg_repetitive_dist['L2_miss'] * 100) / (hg_repetitive_dist['L2_hits'] + hg_repetitive_dist['L2_miss']), label="HG Repetitive", color='g', ls='dashed')
ax2.plot(hg_nonrepetitive_dist['A_len'] + hg_nonrepetitive_dist['B_len'], (hg_nonrepetitive_dist['L2_miss'] * 100) / (hg_nonrepetitive_dist['L2_hits'] + hg_nonrepetitive_dist['L2_miss']), label="HG Non-repetitive", color='r', ls='dashed')
ax2.plot(hg_combined_dist['A_len'] + hg_combined_dist['B_len'], (hg_combined_dist['L2_miss'] * 100) / (hg_combined_dist['L2_hits'] + hg_combined_dist['L2_miss']), label="HG Combined", color='c', ls='dashed')
...
plt.figure()
plt.title("Normalized running time for the grid computation")
plt.xscale('log', basex=2)
plt.ylabel('Normalized running time')
plt.xlabel('N')
...
plt.plot(fibonacci_grid['A_len'] + fibonacci_grid['B_len'], normalize_grid(fibonacci_grid), label="Fibonacci", color='b')
# plt.plot(genome_grid['A_len'] + genome_grid['B_len'], normalize_grid(genome_grid), label="Genome 1 - 2")
plt.plot(hg_repetitive_grid['A_len'] + hg_repetitive_grid['B_len'], normalize_grid(hg_repetitive_grid), label="HG Repetitive", color='g')
plt.plot(hg_nonrepetitive_grid['A_len'] + hg_nonrepetitive_grid['B_len'], normalize_grid(hg_nonrepetitive_grid), label="HG Nonrepetitive", color='r')
plt.plot(hg_combined_grid['A_len'] + hg_combined_grid['B_len'], normalize_grid(hg_combined_grid), label="HG Combined", color='c')
...
plt.figure()
plt.title("Normalized running time for the combined algorithm")
plt.xscale('log', basex=2)
plt.yscale('log', basey=2)
plt.ylabel('Normalized running time')
plt.xlabel('N')
...
plt.plot(fibonacci_total['A_len'] + fibonacci_total['B_len'], normalize_total(fibonacci_total), label="Fibonacci", color='b')
plt.plot(hg_repetitive_total['A_len'] + hg_repetitive_total['B_len'], normalize_total(hg_repetitive_total), label="HG Repetitive", color='g')
plt.plot(hg_nonrepetitive_total['A_len'] + hg_nonrepetitive_total['B_len'], normalize_total(hg_nonrepetitive_total), label="HG Non-repetitive", color='r')
plt.plot(hg_combined_total['A_len'] + hg_combined_total['B_len'], normalize_total(hg_combined_total), ls='dashed', label="HG Combined", color='c')
...
fig = plt.figure()
plt.title("Distribution of running time - Fibonacci")
plt.xscale('log', basex=2)
...
plt.legend([proxy1, proxy2, proxy3], ['SLP compression', 'DIST Repository', 'Grid computation'], loc='upper center', bbox_to_anchor=(0.5, -0.15), fancybox=True, shadow=True, ncol = 3)
...
fig = plt.figure()
plt.title("Distribution of running time - Random")
plt.xscale('log', basex=2)
plt.ylabel('Relative time used')
plt.xlabel('N')
...
fig = plt.figure()
plt.title("Distribution of running time - HG Repetitive")
plt.xscale('log', basex=2)
plt.ylabel('Relative time used')
plt.xlabel('N')
...
fig = plt.figure()
plt.title("Distribution of running time - HG Nonrepetitive")
plt.xscale('log', basex=2)
plt.ylabel('Relative time used')
plt.xlabel('N')
...
fig = plt.figure()
plt.title("Distribution of running time - HG Combined")
plt.xscale('log', basex=2)
plt.ylabel('Relative time used')
plt.xlabel('N')
...
plt.title('Relative running time of the simple and the compression based algorithm')
plt.xscale('log', basex=2)
plt.yscale('log', basey=2)
plt.xlabel('N')
plt.ylabel('Speedup factor')

plt.plot(fibonacci_total['A_len'] + fibonacci_total['B_len'], simple_fibonacci['median'] / fibonacci_total['median'], label="Fibonacci", color='b')
# plt.plot(genome_total['A_len'] + genome_total['B_len'], simple_genome['median'] / genome_total['median'], label="Genomre 1-2")
plt.plot(hg_repetitive_total['A_len'] + hg_repetitive_total['B_len'], simple_hg_repetitive['median'] / hg_repetitive_total['median'], label="HG Repetitive", color='g')
plt.plot(hg_nonrepetitive_total['A_len'] + hg_nonrepetitive_total['B_len'], simple_hg_nonrepetitive['median'] / hg_nonrepetitive_total['median'], label="HG Non-repetitive", color='r')
plt.plot(hg_combined_total['A_len'] + hg_combined_total['B_len'], simple_hg_combined['median'] / hg_combined_total['median'], label="HG Combined", color='c')
